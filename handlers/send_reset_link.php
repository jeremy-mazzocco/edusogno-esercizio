        ...
        if ($result) {
            ...
            if (mysqli_query($conn, $sql_token)) {
                ...
                try {
                    ...
                    $message = 'Messaggio inviato con successo. Controlla la tua email.' . '<br><br>';
                } catch (Exception $e) {
                    $message = "Errore nell'invio del messaggio: {$mail->ErrorInfo}";
                }
            } else {
                $message = "Errore nel salvataggio del token.";
            }
        } else {
...
<body>
    <div class="main">
        <div class="container">
            ...
            <div class="layout-37">
                <div class="rectangle-9" id="reset-pasword-rectangle-9">
