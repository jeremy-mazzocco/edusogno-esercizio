        ...
        <div class="container">
            ...
            <div class="layout-37">
                <div class="rectangle-9">
                    <form action="../../handlers/admin/add_event_handlers.php" method="post" class="box_16">

                        <!-- attendees -->
                        <p class="inserisci-il-nome">Attendees:</p>
                        <input class="mario" type="text" name="attendees" required>
                        ...
                        <input class="rossi" type="text" name="nome_evento" required>
                        <div class="line-4x"></div>

                        <!-- data evento: -->
                        <p class="inserisci-lemail">Data Evento:</p>
                        <input class="name-example-com" type="date" name="data_evento" required>
                        <div class="line-3x"></div>

                        <!-- Aggiungi evento -->
                        <div class="rectangle-10 push-input">
                            <input class="registrati-1" type="submit" value="Aggiungi Evento">
                        </div>
                    </form>
