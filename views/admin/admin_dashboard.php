        ...
        <div class="container">
            <div class="row">
                <?php foreach ($events as $event) : ?>
                    <div class="rectangle-9-rectangle-9x" id="container-join">
                        <p class="nome-evento"><?php echo $event->getNomeEvento(); ?></p>
                        <p class="data-evento"><?php echo $event->getDataEvento(); ?></p>
                        <p class="text-evento"><?php echo $event->getAttendees(); ?></p>
                        <div class="push-input">
                            <div class="registrati-1 rectangle-edit">
                                <a class="text-decoration" href="edit_event.php?id=<?php echo $event->getId(); ?>">EDIT</a>
                            </div>
                        </div>
                        <div class="push-input">
                            <div class="registrati-1 rectangle-delete">
                                <a class="text-decoration" href="../../handlers/admin/delete_event_handlers.php?id=<?php echo $event->getId(); ?>">DELETE</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
