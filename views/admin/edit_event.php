        ...
        <div class="container">
            ...
            <div class="layout-37">
                <div class="rectangle-9">
                    <?php if ($event) : ?>
                        <form action="../../handlers/admin/edit_event_handlers.php" method="post" class="box_16">

                            <input type="hidden" name="id" value="<?php echo $event->getId(); ?>">
                            <!-- nome evento -->
                            <p class="inserisci-il-nome">Nome evento:</p>
                            <input class="mario" type="text" name="nome_evento" value="<?php echo $event->getNomeEvento(); ?>" required>
                            ...
                            <input class="rossi" type="date" name="data_evento" value="<?php echo $event->getDataEvento(); ?>" required>
                            <div class="line-4x"></div>

                            <!-- partecipanti: -->
                            <p class="inserisci-lemail">Partecipanti:</p>
                            <input class="name-example-com" type="text" name="attendees" value="<?php echo $event->getAttendees(); ?>" required>
                            <div class="line-3x"></div>

                            <!-- registrati -->
                            <div class="rectangle-10 push-input">
                                <input class="registrati-1" type="submit" value="Modifica Evento">
                            </div>
                        </form>

                        <div class="hai-gi-un-account-1">
                            <p class="hai-gi-un-account-text">
                                <a href="../admin/admin_dashboard.php">Torna alla Dashboard</a>
                            </p>
                        </div>
            ...
            <div class="layout-38">
                <p class="crea-il-tuo-account">Modifica i tuoi eventi</p>
            </div>
            <div class="layout-39">
