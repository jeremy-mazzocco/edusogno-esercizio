            ...
            <div class="container">
                    ...
                    <div class="vector-4">
                        ...
                        <div class="layout-33">
                            <div class="vector-51">
                                ...
                                <div class="hai-gi-un-account">
                                    <p class="hai-gi-un-account-text-0x">
                                        Hai già un account
                                    </p>
                                    <p class="accedi-text-1x">? Accedi</p>
                                </div>
                ...
                <div class="layout-37">
                    <div class="rectangle-9">
                        <form action="../handlers/registration_handlers.php" method="post" class="box_16">

                            <!-- nome -->
                            <p class="inserisci-il-nome">Inserisci il nome</p>
                            <input class="mario" placeholder="Mario" type="text" name="nome" required>
                            <div class="line-1x"></div>

                            <!-- cognome -->
                            <p class="inserisci-il-cognome">
                                Inserisci il cognome
                            </p>
                            <input class="rossi" placeholder="Rossi" type="text" name="cognome" required>
                            <div class="line-4x"></div>
                            ...
                            <div class="rectangle-10 push-input">
                                <input class="registrati-1" type="submit" value="REGISTRATI">
                            </div>
                        </form>
                        <div class="hai-gi-un-account-1">
                            <p class="hai-gi-un-account-text">
                                Hai già un account ?
                ...
                <div class="layout-38">
                    <p class="crea-il-tuo-account">Crea il tuo account</p>
                </div>
                <div class="layout-39">
