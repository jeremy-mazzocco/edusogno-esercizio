        ...
        <div class="container">
            ...
            <div class="layout-37">
                <div class="rectangle-9" id="reset-pasword-rectangle-9">
                    <form action="../handlers/send_reset_link.php" method="post" class="box_16">

                        <!-- email -->
                        <p class="inserisci-lemail">Inserisci l'email</p>
                        <input class="name-example-com" placeholder="name@example.com" input type="email" name="user_email" required>

                        <!-- registrati -->
                        <div class="line-2x"></div>
                        <div class="rectangle-10 push-input">
                            <input class="registrati-1" type="submit" value="INVIA LINK">
                        </div>
                    </form>
            ...
            <div class="layout-38">
                <p class="crea-il-tuo-account">Resetta la password</p>
            </div>
            <div class="layout-39">
