        ...
        <div class="container">
            <div class="row">
                ...
                foreach ($_SESSION['events'] as $card_event) {
                    echo '<div class="rectangle-9-rectangle-9x" id="container-join">
                    <p class="nome-evento">' . $card_event[0] . '</p> 
                    <p class="data-evento">' . $card_event[1] . '</p>
                    <div class="push-input">
                            <input class="registrati-1" id="rectangle-join" type="submit" value="JOIN">
                        </div>               
                    </div>';
                }
                ?>
            ...
            <div class="layout-38">
                <p class="crea-il-tuo-account" id="eventi-title"> <?php echo 'Ciao ' . $_SESSION['username'] . ' ' . 'ecco i tuoi eventi' ?>
                </p>
            </div>
            <div class="layout-39">
